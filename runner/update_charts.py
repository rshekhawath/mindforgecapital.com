...
FIVE_CHARTS = ["summary.png", "growth.png", "rolling_returns.png", "drawdown.png", "fund_vs_bench.png"]
...
TASKS = [
    ...
    (
        ...
        "<!-- BACKTEST CHARTS -->",
        "<!-- ── LARGEMIDCAP ── -->",
        [("multiasset", n) for n in FIVE_CHARTS],
    ),
    ...
    (
        ...
        "<!-- ── SMALLMICRO ── -->",
        [("largemidcap", n) for n in FIVE_CHARTS],
    ),
    ...
    (
        ...
        "<!-- end tabs-wrap -->",
        [("smallmicro", n) for n in FIVE_CHARTS],
    ),
